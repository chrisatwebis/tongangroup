 ...
 */
function tongan_preprocess_entity(&$variables, $hook) {
  $function = 'tongan_preprocess_' . $variables['entity_type'];
 ...
 */
function tongan_preprocess_field_collection_item(&$variables) {
...
function tongan_preprocess_field(&$variables) {
...
function tongan_preprocess_bean(&$variables) {
 ...
 */
function tongan_preprocess_block(&$variables) {
  // For bean blocks.
 ...
 */
function tongan_preprocess_html(&$vars) {
