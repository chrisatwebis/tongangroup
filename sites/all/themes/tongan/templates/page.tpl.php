...
<header role="banner" id="page-header" >
  <div class="container">
    <div class="row">
      <div class="col-sm-3">
        <div class="row">
          ...
          <?php endif; ?>
          <div id="navbar-mobile" role="banner" class="col-xs-4 col-sm-12">
    ...
    <div class="row">
      <div class="col-sm-12"><?php print render($page['header']); ?></div>
    </div>
    <?php endif; ?>    
  </div>
</header> <!-- /#page-header -->
...
<!-- <div id="search-form-listener" ></div> -->

<div class="page-content" id="page-content">
  <?php if (!empty($page['featured'])): ?>
  <div class="region-wrapper featured-region-wrapper container-fluid">
    <div class="row">
  ...
  <div class="region-wrapper above-content-region-wrapper container-fluid">
    <div class="row">
  ...
  <div class="main-container">
    ...
    <div id="below-content" class="region-wrapper below-content-region-wrapper">
  ...
  <div class="container">
    <div class="row footer-content">
      ...
      <div class="col-sm-8">
        ...
        <div class="region-wrapper footer-region-wrapper">
